...
const CookALookLogo = ({ 
  ...
  const SunglassesIcon = ({ width = 40, height = 16 }: { width?: number; height?: number }) => (
    ...
    >
      {/* Left lens - Wayfarer shape, perfectly upright */}
      <path
        ...
        fill={fillColor}
      />
      {/* Right lens - mirror of left, perfectly upright */}
      <path
