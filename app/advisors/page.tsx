...
import { AdvisorFilters, FilterState } from "@/components/advisors/advisor-filters"
              ...
              return (
                ...
                >
                  <div className="relative aspect-[3/4] overflow-hidden bg-muted">
                    ...
                    {advisor.verified && (
                      <div className="absolute top-2 left-2 px-2 py-0.5 text-[10px] font-sans uppercase tracking-wider bg-gold text-accent-foreground">
                        Verified
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-3 lg:p-4">
                    ...
                    {styleTags.length > 0 && (
                      <div className="flex-wrap gap-1 mb-2 hidden sm:flex">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-border">
                      ...
                      <Button 
                        ...
                        onClick={(e) => {
                          e.stopPropagation()
                          router.push(`/advisors/${advisor.id}`)
                        }}
                      >
                        View
                      </Button>
